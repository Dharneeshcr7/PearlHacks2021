...
class fingernailseg:
    ...
    def fit(self):
        self.model.fit(self.X_train, self.y, validation_split=self.val_split, verbose=0, batch_size=self.batch_size, epochs=self.epochs,                            callbacks=self.build_callbacks())
